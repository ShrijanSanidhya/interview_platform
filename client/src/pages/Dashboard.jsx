...
const Dashboard = () => {
  ...
  return (
    <div className="bg-surface text-on-surface font-body antialiased min-h-screen flex">
      {/* SideNavBar */}
      <nav className="bg-[#e8eaf0] dark:bg-slate-900 h-screen w-72 flex flex-col p-6 sticky top-0 fixed left-0 z-40 shadow-neo dark:shadow-[8px_8px_16px_rgba(0,0,0,0.4),-4px_-4px_16px_rgba(255,255,255,0.05)]">
        <div className="mb-10 pl-2">
          <h1 className="text-2xl font-semibold tracking-tight text-[#6366f1] dark:text-[#818cf8] font-headline">SilkCode</h1>
          <p className="text-on-surface-variant text-sm mt-1">Coding Sandbox</p>
        </div>
        
        <div className="flex-1 space-y-2">
          {/* Active Tab: Dashboard */}
          <a className="shadow-neo-inset dark:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.3)] text-[#6366f1] dark:text-[#818cf8] rounded-xl flex items-center gap-3 px-4 py-3 translate-y-[1px] font-['Plus_Jakarta_Sans'] font-medium text-sm" href="#">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>dashboard</span>
            Dashboard
          </a>
          <a className="text-slate-500 dark:text-slate-400 flex items-center gap-3 px-4 py-3 hover:text-[#6366f1] transition-all hover:shadow-neo dark:hover:bg-slate-800/50 rounded-xl active:scale-[0.97] transition-transform duration-200 font-['Plus_Jakarta_Sans'] font-medium text-sm" href="#" onClick={(e) => e.preventDefault()}>
            <span className="material-symbols-outlined">database</span>
            Question Bank
          </a>
          <a className="text-slate-500 dark:text-slate-400 flex items-center gap-3 px-4 py-3 hover:text-[#6366f1] transition-all hover:shadow-neo dark:hover:bg-slate-800/50 rounded-xl active:scale-[0.97] transition-transform duration-200 font-['Plus_Jakarta_Sans'] font-medium text-sm" href="#" onClick={(e) => { e.preventDefault(); logout(); }}>
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-surface rounded-xl p-8 neo-raised flex flex-col items-center justify-center text-center">
                ...
                <button onClick={createRoom} className="bg-surface text-primary neo-raised rounded-xl py-3 px-8 font-semibold w-full active:neo-pressed transition-all">
                  New Room
                </button>
              </div>
              ...
              <div className="bg-surface rounded-xl p-8 neo-raised flex flex-col justify-center">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button onClick={joinRoom} disabled={!roomId.trim()} className="bg-surface text-primary neo-raised rounded-xl py-3 px-8 font-semibold w-full active:neo-pressed transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                    Join Now
